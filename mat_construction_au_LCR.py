...
for n in range(-1, 2, 1): # zloop
    for o in range(-1, 2, 1): # xloop
        for p in range(-1, 2, 1): # yloop
            ...
            if n==-1:
                f1 = open("../abinit_gold_112/total_mat_au_C/V_CL_"+str(o)+str(p)+".txt", 'w') # write mode
            elif n==0:
                f1 = open("../abinit_gold_112/total_mat_au_C/KC_"+str(o)+str(p)+".txt", 'w') # write mode
            else: # n==1
                f1 = open("../abinit_gold_112/total_mat_au_C/V_CR_"+str(o)+str(p)+".txt", 'w') # write mode
